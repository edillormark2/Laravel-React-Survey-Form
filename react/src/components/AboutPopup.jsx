...
const AboutPopup = ({ openAboutPopup, setOpenAboutPopup }) => {
            ...
            >
                ...
                <div className="p-4">
                    ...
                    <ul className="list-disc list-inside mb-4 p-4 bg-gray-100 rounded-lg mt-4">
                        ...
                        <li className="mb-2">
                            <strong>Share & Publish</strong> - Once your survey
                        ...
                        <li className="mb-2">
                            <strong>Secure & User-Friendly</strong> - Our app is
                    ...
                    <ul className="list-disc list-inside p-4 bg-gray-100 rounded-lg mt-4">
                        ...
                        <li>
                            <strong>Laravel</strong> for a robust and scalable
                            backend solution.
                        </li>
                    </ul>
                </div>
